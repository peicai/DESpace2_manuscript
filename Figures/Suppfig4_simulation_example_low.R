...
library(patchwork)
library(cowplot)
spe = readRDS("./Data/lowly_abundant/ARTISTA_main/simulated_sub.rda")

group1_samples <- c("2DPI_1","5DPI_2", "10DPI_1", "20DPI_2")
group2_samples <- c("2DPI_2","5DPI_1", "10DPI_2", "20DPI_1" )

features <- c("AMEX60DDU001036417", "AMEX60DD055773", "AMEX60DD018732", "AMEX60DD041703")
...
for (i in seq_along(features)) {
  ...
  plots <- lapply(spe, function(spe_j) {
    p <- DESpace::FeaturePlot(spe_j, feature,
...
ggsave("supp_Simulation_Expression_inverted.pdf", plot = final_plot, width = 25, height = 15, units = "in", dpi = 300)